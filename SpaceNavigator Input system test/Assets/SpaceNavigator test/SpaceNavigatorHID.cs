...
namespace UnityEngine.InputSystem.LowLevel
{
    ...
    struct SpaceNavigatorHIDState : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "translation/y", offset = 4, format = "SHRT", parameters = "scale=true, scaleFactor=-1000")]
        [InputControl(name = "translation/z", offset = 2, format = "SHRT", parameters = "scale=true, scaleFactor=-1000")]
        ...
        [InputControl(name = "rotation/y", offset = 4, format = "SHRT", parameters = "scale=true, scaleFactor=1000")] 
        [InputControl(name = "rotation/z", offset = 2, format = "SHRT", parameters = "scale=true, scaleFactor=1000")]
