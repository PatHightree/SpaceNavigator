...
namespace UnityEngine.InputSystem.LowLevel
{
    ...
    struct SpaceNavigatorHIDInputReport : IInputStateTypeInfo
    {
        public FourCC format => new FourCC('H', 'I', 'D');
 
        [FieldOffset(0)] public byte reportId;
 
        // [InputControl(name = "X1", layout = "Axis", offset = 0, format = "BYTE")]
        // [FieldOffset(1)] public byte X1;
        // [InputControl(name = "X2", layout = "Axis", offset = 0, format = "BYTE")]
        // [FieldOffset(2)] public byte X2;
        
        // [InputControl(name = "XS", layout = "Axis", offset = 0, format = "BYTE", parameters = "normalize,normalizeMin=-128,normalizeMax=127,normalizeZero=0.0")]
        // [FieldOffset(2)] public byte X2;

        // [InputControl(name = "translation", format = "VC3S", layout = "Vector3", displayName = "Translation")]
        // [InputControl(name = "translation/x", offset = 1, format = "SHRT")]
        // [InputControl(name = "translation/y", offset = 3, format = "SHRT")]
        // [InputControl(name = "translation/z", offset = 5, format = "SHRT")]
        // [FieldOffset(1)] public Vector3 translation;

        // In 1st report
        [InputControl(name = "TranslationX", layout = "Axis", format = "SHRT")]
        [FieldOffset(1)] public byte TranslationX;
        [InputControl(name = "TranslationY", layout = "Axis", format = "SHRT")]
        [FieldOffset(3)] public byte TranslationY;
        [InputControl(name = "TranslationZ", layout = "Axis", format = "SHRT")]
        [FieldOffset(5)] public byte TranslationZ;

        // In 2nd report
        [InputControl(name = "RotationX", layout = "Axis", format = "SHRT")]
        [FieldOffset(1)] public byte RotationX;
        [InputControl(name = "RotationY", layout = "Axis", format = "SHRT")]
        [FieldOffset(3)] public byte RotationY;
        [InputControl(name = "RotationZ", layout = "Axis", format = "SHRT")]
        [FieldOffset(5)] public byte RotationZ;
        
        // [InputControl(name = "X", layout = "Axis", offset = 1, format = "BYTE", parameters = "normalize,normalizeMin=-1,normalizeMax=1,normalizeZero=0")]
        // [InputControl(name = "Y", layout = "Axis", offset = 3, format = "BYTE", parameters = "normalize,normalizeMin=-1,normalizeMax=1,normalizeZero=0")]
        // [InputControl(name = "Z", layout = "Axis", offset = 5, format = "BYTE", parameters = "normalize,normalizeMin=-1,normalizeMax=1,normalizeZero=0")]
        // [FieldOffset(1)] public byte buttons1;
        
        // [InputControl(name = "buttonSouth", format = "BIT", displayName = "Cross", layout = "Button", bit = 0)]
        // [InputControl(name = "buttonWest", format = "BIT", displayName = "Square", layout = "Button", bit = 1)]
        // [InputControl(name = "buttonEast", format = "BIT", displayName = "Circle", layout = "Button", bit = 2)]
        // [InputControl(name = "buttonNorth", format = "BIT", displayName = "Triangle", layout = "Button", bit = 3)]
        // [InputControl(name = "select", format = "BIT", displayName = "Select", layout = "Button", bit = 4)]
        // [InputControl(name = "start", format = "BIT", displayName = "Start", layout = "Button", bit = 5)]
        // [InputControl(name = "leftStickPress", format = "BIT", displayName = "L3", layout = "Button", bit = 6)]
        // [InputControl(name = "rightStickPress", format = "BIT", displayName = "R3", layout = "Button", bit = 7)]
        // [FieldOffset(1)] public byte buttons1;
        //
        // [InputControl(name = "leftShoulder", format = "BIT", displayName = "L1", layout = "Button", bit = 0)]
        // [InputControl(name = "rightShoulder", format = "BIT", displayName = "R1", layout = "Button", bit = 1)]
        // [InputControl(name = "leftTrigger", format = "BIT", displayName = "L2", layout = "Button", bit = 2)]
        // [InputControl(name = "rightTrigger", format = "BIT", displayName = "R2", layout = "Button", bit = 3)]
        // [InputControl(name = "dpad", format = "BIT", layout = "Dpad", sizeInBits = 4, defaultState = 8)]
        // [InputControl(name = "dpad/up", format = "BIT", layout = "DiscreteButton", bit = 4, sizeInBits = 4, parameters = "minValue=7, maxValue=1, wrapAtValue=7, nullValue=8")]
        // [InputControl(name = "dpad/right", format = "BIT", layout = "DiscreteButton", bit = 4, sizeInBits = 4, parameters = "minValue=1, maxValue=3")]
        // [InputControl(name = "dpad/down", format = "BIT", layout = "DiscreteButton", bit = 4, sizeInBits = 4, parameters = "minValue=3, maxValue=5")]
        // [InputControl(name = "dpad/left", format = "BIT", layout = "DiscreteButton", bit = 4, sizeInBits = 4, parameters = "minValue=5, maxValue=7")]
        // [FieldOffset(2)] public byte buttons2;
        //
        // [InputControl(name = "leftStick", layout = "Stick", format = "VC2B")]
        // [InputControl(name = "leftStick/x", layout = "Axis", offset = 0, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5")]
        // [InputControl(name = "leftStick/left", layout = "Button", offset = 0, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5,clamp,clampMin=0,clampMax=0.5,invert")]
        // [InputControl(name = "leftStick/right", layout = "Button", offset = 0, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5,clamp,clampMin=0.5,clampMax=1")]
        // [InputControl(name = "leftStick/y", layout = "Axis", offset = 1, format = "BYTE", parameters = "invert,normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5")]
        // [InputControl(name = "leftStick/up", layout = "Button", offset = 1, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5,clamp,clampMin=0,clampMax=0.5,invert")]
        // [InputControl(name = "leftStick/down", layout = "Button", offset = 1, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5,clamp,clampMin=0.5,clampMax=1,invert=false")]
        // [FieldOffset(3)] public byte leftStickX;
        // [FieldOffset(4)] public byte leftStickY;
        //
        // [InputControl(name = "rightStick", layout = "Stick", format = "VC2B")]
        // [InputControl(name = "rightStick/x", layout = "Axis", offset = 0, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5")]
        // [InputControl(name = "rightStick/left", layout = "Button", offset = 0, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5,clamp,clampMin=0,clampMax=0.5,invert")]
        // [InputControl(name = "rightStick/right", layout = "Button", offset = 0, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5,clamp,clampMin=0.5,clampMax=1")]
        // [InputControl(name = "rightStick/y", layout = "Axis", offset = 1, format = "BYTE", parameters = "invert,normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5")]
        // [InputControl(name = "rightStick/up", layout = "Button", offset = 1, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5,clamp,clampMin=0,clampMax=0.5,invert")]
        // [InputControl(name = "rightStick/down", layout = "Button", offset = 1, format = "BYTE", parameters = "normalize,normalizeMin=0,normalizeMax=1,normalizeZero=0.5,clamp,clampMin=0.5,clampMax=1,invert=false")]
        // [FieldOffset(5)] public byte rightStickX;
        // [FieldOffset(6)] public byte rightStickY;
        //
        // [InputControl(name = "isPressureOn", format = "BIT", displayName = "Is Pressure On", layout = "Button", bit = 0)]
        // [FieldOffset(7)] public byte isPressureOn;
        //
        // [InputControl(name = "dpadRightPressure", displayName = "DpadRight Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(8)] public byte pressureDR;
        //
        // [InputControl(name = "dpadLeftPressure", displayName = "DpadLeft Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(9)] public byte pressureDL;
        //
        // [InputControl(name = "dpadUpPressure", displayName = "DpadUp Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(10)] public byte pressureDU;
        //
        // [InputControl(name = "dpadDownPressure", displayName = "DpadDown Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(11)] public byte pressureDD;
        //
        // [InputControl(name = "buttonNorthPressure", displayName = "Triangle Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(12)] public byte pressureBU;
        //
        // [InputControl(name = "buttonEastPressure", displayName = "Circle Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(13)] public byte pressureBR;
        //
        // [InputControl(name = "buttonSouthPressure", displayName = "Cross Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(14)] public byte pressureBD;
        //
        // [InputControl(name = "buttonWestPressure", displayName = "Square Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(15)] public byte pressureBL;
        //
        // [InputControl(name = "leftShoulderPressure", displayName = "L1 Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(16)] public byte pressureL1;
        //
        // [InputControl(name = "rightShoulderPressure", displayName = "R1 Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(17)] public byte pressureR1;
        //
        // [InputControl(name = "leftTriggerPressure", displayName = "L2 Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(18)] public byte pressureL2;
        //
        // [InputControl(name = "rightTriggerPressure", displayName = "R2 Pressure", layout = "Axis", format = "BYTE")]
        // [FieldOffset(19)] public byte pressureR2;
    }
 
    [InputControlLayout(stateType = typeof(SpaceNavigatorHIDInputReport))]
    #if UNITY_EDITOR
    [InitializeOnLoad] // Make sure static constructor is called during startup.
    #endif
    public class SpaceNavigatorHID : Gamepad
    {
...
// // to our struct.
// public struct SpaceNavigatorState : IInputStateTypeInfo
// {
...
//     // of the state struct.
//
//     // [InputControl(name = "x", offset = 8, format = "SHRT", layout = "Axis", displayName = "X")]
//     // public int x;
//
//     [InputControl(name = "rx", offset = 1, format = "SHRT", layout = "Axis", displayName = "RX", sizeInBits = 16, processors = "axisDeadzone", parameters = "normalize=true,normalizeMin=-0.01525879,normalizeMax=0.01525879,normalizeZero=0")]
//     public int rx;
//     [InputControl(name = "ry", offset = 3, format = "SHRT", layout = "Axis", displayName = "RY", sizeInBits = 16, processors = "axisDeadzone", parameters = "invert=true,normalize=true,normalizeMin=-0.01525879,normalizeMax=0.01525879,normalizeZero=0")]
//     public int ry;
//     [InputControl(name = "rz", offset = 5, format = "SHRT", layout = "Axis", displayName = "RZ", sizeInBits = 16, processors = "axisDeadzone", parameters = "normalize=true,normalizeMin=-0.01525879,normalizeMax=0.01525879,normalizeZero=0")]
//     public int rz;
//
//     // [InputControl(name = "translation", offset = 8, format = "VC3S", layout = "Vector3", displayName = "Translation")]
//     // [InputControl(name = "translation/x", defaultState = 0.0f, format = "SHRT", parameters = "normalize,normalizeMin=-32768,normalizeMax=32768,normalizeZero=0.0")]
//     // [InputControl(name = "translation/y", defaultState = 0.0f, format = "SHRT", parameters = "normalize,normalizeMin=-32768,normalizeMax=32768,normalizeZero=0.0")]
//     // [InputControl(name = "translation/z", defaultState = 0.0f, format = "SHRT", parameters = "normalize,normalizeMin=-32768,normalizeMax=32768,normalizeZero=0.0")]
...
// #endif
// [InputControlLayout(stateType = typeof(SpaceNavigatorState))]
// public class SpaceNavigatorDevice : InputDevice, IInputUpdateCallbackReceiver
// {
//     // [InitializeOnLoad] will ensure this gets called on every domain (re)load
//     // in the editor.
// #if UNITY_EDITOR
//     static SpaceNavigatorDevice()
//     {
...
//
//         InputSystem.RegisterLayout<SpaceNavigatorDevice>(
//             matches: new InputDeviceMatcher()
//                 .WithInterface("HID")
//                 // .WithManufacturer("3Dconnexion")
//                 // .WithProduct("SpaceNavigator"));
...
//     public AxisControl rx { get; private set; }
//     public AxisControl ry { get; private set; }
//     public AxisControl rz { get; private set; }
...
//         base.FinishSetup();
//
//         rx = GetChildControl<AxisControl>("rx");
//         ry = GetChildControl<AxisControl>("ry");
//         rz = GetChildControl<AxisControl>("rz");
...
//     public static SpaceNavigatorDevice current { get; private set; }
//
...
//
// #if UNITY_EDITOR
//     [MenuItem("Tools/Custom Device Sample/Create SpaceNavigator")]
...
//     [MenuItem("Tools/Custom Device Sample/Remove SpaceNavigator")]
//     private static void RemoveDevice()
//     {
//         var customDevice = InputSystem.devices.FirstOrDefault(x => x is SpaceNavigatorDevice);
...
//             return;
//
//         var state = new SpaceNavigatorState();
//
//         // state.x = 0;
//
